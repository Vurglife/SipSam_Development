...
function resolveRound(playerHands, bankerHands, betAmount, playerDeclaredSpecial, bankerDeclaredSpecial) {
    ...
    if (ps && bs) {
        ...
        const bonus       = SPECIAL_BONUS[winSpecial.name] || 0;
...
module.exports = {
    ...
    SPECIAL_BONUS, bestSuitRank, sixHalfExtraCard
};
