...
const UserDB = {
    ...
    async findByUsername(username) {
        await getDb();
        // Case-insensitive lookup so "Vurglife" and "vurglife" resolve to the same user
    ...
    async findByEmailOrUsername(identifier) {
        await getDb();
        // Both email (already stored lowercase) and username (case-insensitive) checked
        return get('SELECT * FROM users WHERE email = ? OR username = ? COLLATE NOCASE',
